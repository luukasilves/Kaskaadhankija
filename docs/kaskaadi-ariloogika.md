...
| **Koolitus** | Üks tellitav ühik: töötuba või sündmus kindla kuupäeva, asukoha, formaadi, **maksimaalse** osalejate arvu ja keelega; hind tuleneb partneri raamlepingu ühikuhinnast osaleja kohta (T-08). Klastri **rühm** on koolitus, millel on kindla kuupäeva asemel periood (v2.7). |
...
| **Klaster** | Mahuline tellimus ühe reana: N osalejat ühes maakonnas või asukohas ühe **perioodi** jooksul, kindla kuupäevata (nt „500 ettevõtjat Tartus okt–dets 2026“). Rakenduses on klaster G ühesugust **rühma**, mis kannavad klastri koodi (`KL-2026-001`) ja on omavahel vahetatavad (K-10, L-28). |
| **Rühm** | Klastri üks osa ja jaotuse ühik: koolitus perioodiga kuupäeva asemel, koodiga `KL-2026-001-07` (klastri kood ja rühma järjekorranumber), kuni `ruhma_suurus` osalejat. Rühm määratakse ühele partnerile nagu iga koolitus (J-07); toimumisaeg perioodi sees lepitakse kokku pärast jaotust väljaspool rakendust (L-28). |
| **Voor** | Üks paralleelne kaskaad: ühe hankeosa koolituste komplekt, mis avaldatakse **kõigile** selle hankeosa aktiivsetele partneritele ühel hetkel ühe vastamistähtajaga. Voor on ühte liiki — kindla kuupäevaga koolitused või klastrid (V-09). |
...
- **[V-09] Vooru liik** *(v2.7)*. Voor on ühte liiki: **kindla kuupäevaga koolituste voor** või **klastrivoor** (rühmad, K-10). Liik määratakse **esimese vooru lisatud koolitusega** ja seda ei muudeta; teist liiki koolituse lisamine mustandisse, vooru töövihikusse (L-20) või jäägi uude vooru andmisel (T-06) lükatakse tagasi selge teatega („Voor VOOR-2026-004 on kindla kuupäevaga koolituste voor; klastri rühma KL-2026-001-02 sinna lisada ei saa.“). **Kombineeritud loogikat ei ole**: samu koolitusi ei pakuta kunagi korraga üksikult ja mahuna — tellija tiim välistas selle läbimängul. Klastrivoorus võib olla mitu klastrit; iga klaster jaotatakse eraldi (J-02 täpsustus). Vooru liik **ei sõltu hankeosast**: iga hankeosa võib täna teha kindla kuupäevaga vooru ja homme klastrivooru; mis liiki tellimist raamleping igas hankeosas lubab, kontrollib tellija raamlepingu tekstiga (L-28). Rühma eemaldamine voorust (V-04) käib nagu koolituse eemaldamine: klaster on selles voorus edaspidi ühe rühma võrra väiksem ja eemaldatud rühmale antud märked tühistuvad — kanoonilise salvestuse tõttu (K-10) puudutab see partnereid, kes küsisid vähemalt eemaldatud rühma järjekorranumbri võrra rühmi, mistõttu on mõistlik eemaldada viimane rühm.
...
- **[K-06] Piirmäär.** Partner võib vooru kohta määrata ülempiiri. Tellija valib vooru loomisel (vaikimisi hankeosa seadistusest), millised piirmäära **liigid** on voorus lubatud: **koolituste arv** („võtan vastu kuni N koolitust“), **osalejate arv kokku** („võtan vastu kuni N osalejat“ — määratavate koolituste osalejate arvude summa), mõlemad (partner valib ühe) või mitte ükski. Vaikimisi piirmäära ei ole (= kõik kinnitatud märked). Piirmäära sees jaotatakse koolitused **toimumiskuupäeva järjekorras** (varasem enne), võrdsete kuupäevade puhul koolituse tunnuse järjekorras. Osalejate arvu piirmäära puhul jäetakse koolitus, mis järelejäänud eelarvesse ei mahu, **vahele ja järgmisi proovitakse edasi**. Üksiku töötoa osalejate ülempiir (raamlepingus 75) on koolituse enda omadus, mida rakendus ei kontrolli. *Alternatiivid — vt L-03, L-17.*
  ...
  *Täpsustus (v2.7):* lause „üksiku töötoa osalejate ülempiir … mida rakendus ei kontrolli“ täpsustub: ülempiir on hankeosa andmetes (`max_osalejaid_ruhmas`, L-21; näidisandmetes 75 hankeosades OSA-1 ja OSA-2) ja rakendus **hoiatab** kindla kuupäevaga koolituse impordil, kui max osalejaid selle ületab, ning **keeldub** klastri rühmast, mis on ülempiirist suurem (K-10). Klastrivoorus loeb koolituste arvu piirmäär rühmi ja osalejate arvu piirmäär rühmade osalejate summat.
...
- **[K-10] Klastri märkimine ja rühmade vahetatavus** *(v2.7)*. Klastrivoorus (V-09) ei märgi partner üksikuid rühmi, vaid ütleb iga klastri kohta **arvu**: „võtan kuni n rühma“ (0…G). Rühmad on omavahel **vahetatavad**: tulemus sõltub ainult sellest, *mitu* rühma partner kinnitas, mitte sellest, *millised* (J-03). Rakendus salvestab kinnituse **kanooniliselt** — n märgitud rühma on alati klastri n esimest rühma järjekorranumbri järgi —, nii et kinnitus on tõendina üheselt loetav ja sisult identse korduskinnituse reegel (E-10) töötab. Jaotuses (J-02) saab partner klastrist n esimest **veel jaotamata** rühma. Näide: 10 rühma, koht 1 kinnitab 4 ja koht 2 kinnitab 6 → koht 1 saab rühmad 01–04 ja koht 2 rühmad 05–10; kui koht 2 oleks kinnitanud 8, saaks ta 6 (05–10) ja kaks jääks katmata. Piirmäär (K-06) loeb rühmi koolitustena; piirmäära tõttu võtmata jäänud rühmad voolavad alla (E-04). Rühmade toimumisajad perioodi sees lepitakse kokku pärast jaotust väljaspool rakendust (L-28). Kindla kuupäevaga koolituste voorus K-10 midagi ei muuda.
...
- **[N-03] Dünaamiline režiim (vaikimisi).** Iga koolituse juures kuvatakse partnerile üks neljast olekust, arvutatuna jaotusalgoritmiga (J) **kõrgema kohaga partnerite kinnitatud** märgete põhjal:
  ...
  *Täpsustus (v2.7, klastrid):* klastrivoorus (V-09) kuvatakse neli olekut **klastri kohta arvudena**, mitte rühma kohta: mitu rühma on eesõigusega partnerid kinnitanud (kokku, nimedeta ja märkijate arvuta — N-04 keelab märkijate arvu, mitte rühmade arvu), mitu on vaba, mitu partner ise küsis ja mitu on „prognoosis teile“; koond „Prognoosis teile: X rühma“ on rühmade summa üle klastrite. Sildid on samad; põhjus „eesõigusega partner“ / „üle teie piirmäära“ käib küsitud, aga prognoosis mitte oleva osa kohta. Tellija maatriksis (N-01) on klaster üks rida partnerite rühmade arvudega, rühmad selle all.
...
- **[J-02] Protseduur.**
  ...
  *Täpsustus (v2.7):* klastrivoorus (V-09) on `soovitud` klastri K kohta **n_K esimest veel jaotamata rühma** järjekorranumbri järgi, kus n_K on partneri kinnitatud rühmade arv selles klastris (K-10) — mitte tema märgitud rühmad ise. Mitu klastrit ühes voorus on üksteisest sõltumatud; järjekord „(toimumiskuupäev, tunnus)“ on rühmadel (perioodi algus, tunnus). Piirmäära tõttu võtmata jäänud rühmad jäävad jaotamata hulka ja järgmine partner saab jällegi *esimesed* jaotamata rühmad (E-04). Osalejate eelarve puhul käiakse läbi ainult need n_K rühma: väiksem jääkrühm, mis mahuks eelarvesse, kuid ei ole n_K esimese seas, jääb võtmata (L-28 alternatiiv (e)). Algoritmi versioon on 2; varasemate hetktõmmiste tulemus ei muutu, sest neis klastreid ei ole.
...
- **[D-01] Avaldamine.** Kõigile partneritele ühel hetkel: koolituste loend, tähtaeg, nähtavusrežiim, link vastamiseks, selgitus esialgsuse kohta (N-05). Koopia tellimismeeskonnale.
  ...
  *Täpsustus (v2.7):* klastrivoorus (V-09) on loendi rida **klaster**, mitte rühm: kood, nimetus, periood, formaat, maakond ning „G rühma × kuni S osalejat (N kokku)“; partneri enda loendites (D-02, D-11, D-12) lisandub tema osa — „6 rühma (05–10)“. Ühikuks on teadetes „rühma“, kindla kuupäevaga voorus „koolitust“.
...
- **[L-17] Piirmäära liik: koolituste või osalejate arv.**
  ...
  **Märkus:** üksiku töötoa osalejate ülempiir (raamlepingus 75) on koolituse enda omadus ja rakendus seda ei kontrolli — *v2.7: ülempiir on hankeosa andmetes ja rakendus hoiatab või keeldub (K-06 täpsustus, L-21)*. Enne v2.2 külmutatud hetktõmmised ei sisalda koolituste osalejate arve; need täiendatakse lugemisel koolituse andmetest, mis jaotust ei muuda, sest neis voorudes osalejate piirmäära ei olnud.
...
- **[L-20] Vooru skeemi üleslaadimine tabelina.**
  ...
  *Täpsustus (v2.7, klastrid):* lehe „Koolitused“ rida võib olla **klaster** (L-28 veerud `periood_algus`, `periood_lopp`, `ruhma_suurus`, `ruhmi`); üks klastri rida loob või tähistab G rühma. Ühe mustandi read peavad olema ühte liiki (V-09) — kindla kuupäevaga ja klastri rida samas hankeosas on faili viga („Ühes voorus ei saa olla korraga kindla kuupäevaga koolitusi ja klastreid — voor on ühte liiki [V-09]. Tee kaks vooru.“); tühja hankeosaga failis kehtib nõue iga hankeosa mustandi kohta eraldi. Rakendusest alla laaditud mall kirjutab hankeosa jaotamata rühmad **ühe klastri reana** (rühmade arv ja osalejad kokku), nii et fail loeb nagu tellimus, mitte nagu rühmade loend; olemasoleva klastri rida failis tähistab tema **vabu** rühmi ja tema `ruhmi` peab nende arvuga võrduma.
...
- **[L-21] Raamhanke andmete haldus.**
  ...
  *Täpsustus (v2.7):* leht „Hankeosad“ saab veeru **`max_osalejaid_ruhmas`** — hankeosa ühe rühma (töötoa) osalejate ülempiir raamlepingu järgi; vabatahtlik, tühi tähendab, et piiri ei ole; sama väli on ekraanil hankeosa vormil. Näidisandmetes 75 hankeosades OSA-1 ja OSA-2, sest raamlepingus on töötoa ülempiir 75. Rakendus hoiatab kindla kuupäevaga koolituse impordil, kui max osalejaid ületab piiri, ja keeldub klastri rühmast, mis on piirist suurem (K-06 täpsustus, L-28).
...
- **[L-22] Vooru protokoll.**
  ...
  *Täpsustus (v2.7):* klastrivooru (V-09) protokollis on koolituste tabelis rühmad klastri päise all ja jaotusele lisandub **„Klastrite kokkuvõte“** — iga klastri kohta iga täitja rühmade arv, rühmade numbrid ja osalejaid kokku, nii PDF-is kui .xlsx lisas. Andmestruktuur v2 saab vabatahtlikud väljad (perioodi liik, klastri kood, rühma number); varasemad kanded loetakse kindla kuupäevaga koolitustena.
...
- **[L-23] Testkeskkonna aeg ja näidismasinavärk.**
  ...
  **Tagajärg:** puhta seisu taastamine on halduri toiming (uus andmemaht), mitte nupp rakenduses. Näidisandmed laaditakse esimesel käivitusel tühja andmebaasi — sama impordi kaudu, mida admin ise kasutab (L-21). *Täpsustus (v2.7, 14.09.2026):* toodangujuurutus jätab näidisandmed laadimata (seadistus `SEED_SAMPLE_DATA=0`) ja alustab tühjast andmebaasist, kuhu esimene admin laadib päris raamhanke töövihiku (L-21).
...
- **[L-28] Mahuline tellimine — klaster rühmadena.**
  **Valik:** tellija võib koolituse asemel tellida **mahu**: N osalejat ühes maakonnas või asukohas ühe perioodi jooksul (M: Klaster). Rakenduses on klaster **G ühesugust rühma** — iga rühm on tavaline koolitus, millel on kuupäeva asemel periood, kood `KL-AAAA-NNN-RR` (klastri kood ja rühma järjekorranumber, G ≤ 99) ja kuni `ruhma_suurus` osalejat (viimane rühm kannab jäägi). Nii jääb kehtima „üks rida = üks koolitus = maksimaalselt üks täitja“ (J-07) ning kinnitused, jaotus, protokoll, töömahu arvestus (rühm loeb koolitusena) ja jäägi käsitlus (T-06) töötavad muutmata; **ainus algoritmiline muutus** on see, et partneri soovitud rühmad klastris on n esimest veel jaotamata rühma (J-02 täpsustus), mis teeb rühmad vahetatavaks (K-10). Klastri rida koolituskalendris ja vooru töövihikus (L-20) kannab veerge `periood_algus`, `periood_lopp` (täidetud → rida on klaster; `kuupaev` ja `lopp_kuupaev` peavad olema tühjad), `ruhma_suurus` (1 … hankeosa ülempiir `max_osalejaid_ruhmas`, L-21) ja `ruhmi` (1–99; tühi → ⌈osalejate_arv / ruhma_suurus⌉; kui mõlemad on antud, peavad need klappima); `hinnanguline_maksumus` on kogu klastri hinnang ja jagatakse rühmadele osalejate järgi (L-26). Klastri kood on `KL-`, koolituse `KK-`; rühma koodi failis ei kirjutata — rühmad tuletatakse. Olemasoleva klastri rühmade arvu faili kaudu ei muudeta ja tema rida tähistab tema vabu rühmi (L-20 täpsustus). Vooru liik on vooru, mitte hankeosa omadus (V-09). Klastri hind rühma täitumisel on partnerile ruhma_suurus × tema ühikuhind (T-08).
  **Põhjendus:** läbimängul küsis tellija tiim, kas saab „korraga tellida ettevõtjatele näiteks viiesajale Harjumaal perioodil oktoober–detsember“ ilma kindlat kuupäeva panemata, sest „300 Tartus tähendab kuut töötuba“ ja „Hiiumaal 35, Harjumaal 350 — saaks panna klastri“; osalejate arvu alusel tellimist peeti heaks mõtteks. Ühtlasi välistati kombineeritud loogika: samu koolitusi ei pakuta korraga üksikult ja mahuna.
  **Alternatiivid:** (a) jagatav osalejapõhine jaotus — partner saab „300 osalejat“ rühmadeta: rikub J-07 ja teeb protokolli ühikuks osaleja, mida ei saa läbi viia; (b) eraldi klastri tabel ja eraldi jaotusloogika — kaks teed igas ekraanis, teates ja protokollis; (c) rühmade märkimine ükshaaval ilma vahetatavuseta — koht 2, kes märkis rühmad 01–06, saaks pärast koht 1 nelja rühma ainult 05 ja 06 (4 + 2, mitte 4 + 6); (d) piirmäär klastri kohta jaotamata hulka kokku võtmata — sama tulemus kui (c) teise nime all; (e) osalejate eelarve käib läbi klastri kõik jaotamata rühmad, mitte ainult esimesed n — kasutab eelarvet paremini (väiksem jääkrühm mahuks), aga teeb tulemuse raskemini ette ennustatavaks; võetakse, kui tellija soovib tihedamat eelarvekasutust.
  **Lahtine:** rühmade toimumisaegade määramine pärast jaotust — praegu kokkulepe väljaspool rakendust, hiljem rühma kuupäev rakenduses või kokkuleppevoog; milline hankeosa millist liiki tellimist raamlepingu järgi lubab — tellija kontrollib raamlepingu tekstiga, rakendus ei eelda midagi; näidisandmete hankeosa OSA-1 kirjeldus („koolitused ruumirendiga“) võib olla vale — läbimängul arvati nii; see on andmeparandus raamhanke töövihikus (L-21), mitte koodi muudatus.
  **Seis:** mudel otsustatud tellija tiimiga (september 2026); esimene klastrivoor piloodi ajal.
...
| **2.7** | **13.09.2026** | Piloodi ajal tehtavad muudatused. Mahuline tellimine klastrina: uued mõisted **Klaster** ja **Rühm**, uus **V-09** (voor on ühte liiki — kindla kuupäevaga koolitused või klastrid; liik määratakse esimese koolitusega, kombineeritud loogikat ei ole, liik ei sõltu hankeosast), uus **K-10** (partner kinnitab klastri kohta rühmade arvu; rühmad on vahetatavad; kinnitus salvestatakse kanooniliselt; 4 + 6 näide), täpsustused **J-02** (soovitud on klastri n esimest veel jaotamata rühma; algoritmi versioon 2), **N-03** (olekud klastri kohta arvudena), **D-01** (loendi rida on klaster; ühik „rühma“), **K-06** ja **L-17** (osalejate ülempiir on hankeosa andmetes — hoiatus kindla kuupäevaga real, keeldumine klastri rühmal), **L-20** (klastri rida töövihikus, ühe mustandi read ühte liiki, mall kirjutab vabad rühmad ühe reana), **L-21** (veerg `max_osalejaid_ruhmas`, näidisandmetes 75 hankeosades OSA-1 ja OSA-2) ja **L-22** (protokollis „Klastrite kokkuvõte“, vabatahtlikud väljad) juurde; uus **L-28** (mudel ja alternatiivid: jagatav osalejapõhine jaotus, eraldi tabel, ükshaaval märkimine, klastri piirmäär, eelarve käik üle kõigi rühmade; lahtine toimumisaegade määramine). Migratsioon lisab koolitusele perioodi liigi, klastri koodi ja rühma numbri, voorule liigi ja hankeosale rühma ülempiiri; kõik senised read loetakse kindla kuupäevaga koolitusteks kindla kuupäevaga voorudes. Täpsustus **D-10** juurde: teated jagunevad formaalseteks (alati e-postiga) ja teabekirjadeks (kviitungid, prognoosi muutus, lõppkokkuvõte), mille esindaja võib enda jaoks e-postist välja lülitada; uus **L-27** (üks isiklik lüliti, vaikimisi sisse; alternatiivid liigiti, päevakoond, prognoosi muutus vaikimisi väljas). Läbimängul oli ühe vooru kohta „10 meili“. Täpsustus **N-03** juurde: sildid teie-vormis („Prognoosis teile“, „üle teie piirmäära“), ka Lisa B tabelites; keskkonna üks nimi on „testkeskkond“. Raamhanke töövihiku Selgitus (L-21) ütleb, et lehel „Partnerid“ on üks rida ettevõtte ja hankeosa kohta (kolmes hankeosas olev ettevõte on kolmel real), et „Esindajad“ on lisainimesed ja kontaktisik on esindaja automaatselt, ning et hankeosa kirjeldus tuleb raamlepingu sõnastusega kontrollida — läbimängul tekitasid kõik kolm segadust. Täpsustus **L-20** juurde: tühja hankeosaga „Voor“ leht loob ühe impordiga iga hankeosa kohta oma mustandi; voor jääb ühe hankeosa vooruks. Täpsustus **N-02** juurde: partneri kalender („Minu kalender“ — määratud ja kinnitatud koolitused kuude kaupa) ja märkimistabeli hoiatus „Samal päeval: …“. Täpsustus **L-23** juurde (lisatud 14.09.2026): toodangujuurutus näidisandmeid ei laadi (`SEED_SAMPLE_DATA=0`) ja alustab tühjast andmebaasist. |
